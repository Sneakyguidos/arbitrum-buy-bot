...
# Check the current price of Ethereum on Arbitrum
current_price = requests.get("https://arbitrum.com/ethereum/price").json()["price"]
...
if current_price >= target_price:
    ...
    buy_order = requests.post("https://arbitrum.com/ethereum/buy", data={"usdc": eth_to_buy * current_price, "from": account.address})
